    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1"> 
      ...
      <ul id="nav-top" class="nav navbar-nav navbar-right">
		   <li><a href="index.html" class="page-scroll">Home</a></li>
	        <li><a href="/MVCBoard2/Board.do?action=write" class="page-scroll">게시물 작성</a></li>
	        <li><a href="/MVCBoard2/Board.do?action=list" class="page-scroll">게시물 목록</a></li>
      </ul>
    </div>
    <!-- /.navbar-collapse --> 
  </div>
  ...
  <div class="container">
    <div class="row wow fdeInUp"> 
      ...
      <div class="col-md-12 page-block">
		<form action='<c:url value="/MVCBoard2/Board.do"/>' method="post">
